...
| --- | --- | --- |
| **📱 Android** | **[⬇️ Download YahBible v0.2 (Android APK, 59 MB) →](https://huggingface.co/OhBeOneKeyNoBe/YahBible-Mobile/resolve/main/YahBible-v0.2.apk)** | Open the `.apk`, allow "install from this source", tap Install. |
